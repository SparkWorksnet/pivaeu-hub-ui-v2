      ...
      <div class="grid grid-cols-3 items-center">
        ...
        <div class="flex items-center">
          <RouterLink class="block" to="/">
            <img src="../../../public/piveau-logo.png" alt="piveau logo" class="w-40">
          </RouterLink>
        </div>
        ...
        <div class="flex items-center justify-end gap-4">
          ...
          <div class="hidden md:flex items-center gap-4">
            ...
            <a target="_blank" href="https://doc.piveau.eu/general/introduction/"
               class="flex items-center font-light ml-4 text-surface">
            ...
            <a target="_blank" href="https://gitlab.com/piveau/"
               class="flex items-center font-light text-surface">
